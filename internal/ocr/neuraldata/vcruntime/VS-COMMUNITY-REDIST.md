---
layout: Conceptual
title: Visual Studio Redistribution | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/visualstudio/releases/2026/redistribution
uhfHeaderId: MSDocsHeader-VisualStudio
breadcrumb_path: /visualstudio/releases/_breadcrumb/toc.json
...
description: Find the Distributable Code for Microsoft Visual Studio
locale: en-us
document_id: 8dec1136-9af5-6c51-ba9b-dcb032923b2f
document_version_independent_id: 8dec1136-9af5-6c51-ba9b-dcb032923b2f
updated_at: 2025-11-11T15:37:00.0000000Z
original_content_git_url: https://devdiv.visualstudio.com/DefaultCollection/DevDiv/_git/RECON?path=/visualstudio-release-docs/releases/2026/redistribution.md&version=GBlive&_a=contents
gitcommit: https://devdiv.visualstudio.com/DefaultCollection/DevDiv/_git/RECON/commit/088fac34be5ee5556a34782bfd9918fd7249cd0f?path=/visualstudio-release-docs/releases/2026/redistribution.md&_a=contents
git_commit_id: 088fac34be5ee5556a34782bfd9918fd7249cd0f
site_name: Docs
depot_name: MSDN.visualstudio-release-docs
page_type: conceptual
toc_rel: ../toc.json
pdf_url_template: https://learn.microsoft.com/pdfstore/en-us/MSDN.visualstudio-release-docs/{branchName}{pdfName}
feedback_product_url: ''
feedback_help_link_type: ''
feedback_help_link_url: ''
word_count: 1114
asset_id: releases/2026/redistribution
moniker_range_name: 
monikers: []
item_type: Content
source_path: visualstudio-release-docs/releases/2026/redistribution.md
cmProducts:
...
platformId: c17ac6b2-401c-d370-e9be-a87974cfd3cc
---

# Visual Studio Redistribution | Microsoft Learn

This page provides the list of distributable code files and utilities for Visual Studio 2026 and later.

## On this Page

- List of Utilities for Visual Studio
- Distributable Code Files for Visual Studio

Note

In the lists below...

- [arch] represents the processor architecture identifier, for instance "x64", or "arm64".
...
- [VisualStudioFolder] represents the install location for Visual Studio.

## List of Utilities and Build Tools for Visual Studio 2026 and later

This is the "Utilities List" that is referenced in the "Utilities" section of Microsoft Software License Terms for certain editions of Visual Studio 2026 and later (the "software"). Depending on the specific edition of the software, the software you received may not include all of the files on this list. To determine your rights with respect to the following files, please refer to the Visual Studio License Terms that came with your edition of the software. You may not modify these files. Some Utilities by their nature may make it possible for others to access the devices on which the Utilities are installed. You should delete all Utilities you have installed after you finish debugging or deploying your applications and databases

### Diagnostic Tools

[IntelliTrace Standalone Collector for Visual Studio](https://visualstudio.microsoft.com/downloads/#intellitrace-standalone-collector-for-visual-studio-18)

- [VisualStudioFolder]\Common7\IDE\CommonExtensions\Microsoft\IntelliTrace\IntelliTraceCollection.cab

[Remote Tools for Visual Studio](https://visualstudio.microsoft.com/downloads/#remote-tools-for-visual-studio-18)

- vs\_remotetools.exe (x86, x64, ARM64 versions)

### Visual C++ Utilities

The "Utilities List" includes all files within the subfolders of the directories specified (if present):

- [VisualStudioFolder]\VC\Redist\MSVC\[version]\debug\_nonredist[arch]\
    - Microsoft.VC[version].DebugCRT
    - Microsoft.VC[version].DebugCXXAMP
    - Microsoft.VC[version].DebugMFC
    - Microsoft.VC[version].DebugOpenMP
    - Microsoft.VC[version].OpenMP.LLVM
...
## Distributable Code Files for Visual Studio 2026 and later

The following section is the "Distributable List" or the "REDIST.TXT" that is referenced in the "Distributable Code" section of the Microsoft Software License Terms for Visual Studio Enterprise, Visual Studio Professional, Visual Studio Community, and Visual Studio Build Tools ("the software"). If you have a validly licensed copy of such software, you may copy and distribute with your program the unmodified form of the files listed below, subject to the License Terms for the software.

Important

Files and components marked as "pre-release" or "preview" in the software are not licensed for redistribution.

### ASP.NET Libraries

The following software components are licensed and supported separately under the Microsoft .NET Library terms located at https://aka.ms/dotnet-library-license-vs. If you do not agree to the license terms for these software components, you may not use them.
...
- dotNetFx-x86-x64-AllOS-ENU.exe (.NET Framework redistributable as present in Visual Studio)
- NDP[ver]-KB[number]-x86-x64-AllOS-ENU.exe (.NET Framework redistributable as present on other channels, such as the Microsoft Download Center) Note: Both files are identical but may use different names for different distribution channels.
...
- [ver] represents a 3 digit version such 462 or 481. For instance, NDP462-KB[number]-x86-x64-AllOS-[locale].exe
- [number] represents a numeric KB number such as 3151800. For instance, NDP462-KB3151800-x86-x64-AllOS-[locale].exe
...
- [VisualStudioFolder]\VC\Redist\MSVC\[version]\MergeModules\Microsoft\_VC145\_CRT\_[arch].msm
- [VisualStudioFolder]\VC\Redist\MSVC\[version]\MergeModules\Microsoft\_VC145\_CXXAMP\_[arch].msm
- [VisualStudioFolder]\VC\Redist\MSVC\[version]\MergeModules\Microsoft\_VC145\_MFCLOC\_[arch].msm
- [VisualStudioFolder]\VC\Redist\MSVC\[version]\MergeModules\Microsoft\_VC145\_MFC\_[arch].msm
- [VisualStudioFolder]\VC\Redist\MSVC\[version]\MergeModules\Microsoft\_VC145\_OpenMP\_[arch].msm
...
The same Visual C++ Runtime Redistributable package is available from [Latest supported Visual C++ Redistributable downloads](/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170) and [Download Visual Studio Tools](https://visualstudio.microsoft.com/downloads/#microsoft-visual-c-redistributable-for-visual-studio-18). Distribution of the Visual C++ Runtime Redistributable package, merge modules, and individual binaries obtained from those pages is limited to licensed Visual Studio users and is subject to its license terms.

Note

You may *not* distribute the contents of the following folders (please see List of Utilities and Build Tools for Visual Studio for allowed usage for development/testing purposes):

- [VisualStudioFolder]VC\Redist\MSVC\[version]\debug\_nonredist
- [VisualStudioFolder]\VC\Redist\MSVC\[version]\onecore\debug\_nonredist
