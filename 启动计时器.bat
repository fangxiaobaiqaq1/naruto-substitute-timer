...
rem Default to the current local candidate; callers may override TARGET_VERSION for a future candidate.
if not defined TARGET_VERSION set "TARGET_VERSION=v0.2.8"
